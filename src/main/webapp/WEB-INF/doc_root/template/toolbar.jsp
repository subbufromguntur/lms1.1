...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%>
    ...
    <a href="#" id="alert"></a><br>
        <form:form commandName="clientBean" action="addClientGlAccount" method="POST" class="box validate" id="id_gl_account_form">
			<div class="row">
                <label for="d2_role">
                ...
                <div>
                    <select name="accountType" id="id_accountType1" class="search" data-placeholder="Choose a accountType" >  
								...
								<c:forEach items="${programData.glAccountType}" var="accTypeObj" varStatus="accTypeObjList">
        ...
        <div class="actions validate">
            <div class="left">
                <input type="button" value="Cancel" name=# id="id_popup_cancel" class="grey cancel"/>
            </div>
            <div class="right">
                <input type="submit" value="Add GL Account" name=submit id="id_popup_glscreen"/>
            </div>
        </div>
