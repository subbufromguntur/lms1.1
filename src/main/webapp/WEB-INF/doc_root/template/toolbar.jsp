...
<div id="settings" class="settings-content" data-width=450>
	...
	<ul class="tabs center-elements">
		<li><a href="#settings-1"><img
				src="img/icons/packs/fugue/24x24/user-business.png" alt="" /><span>Account
					Settings</span></a></li>
		<li><a href="#settings-2"><img
				src="img/icons/packs/fugue/24x24/balloon.png" alt="" /><span>Notifications</span></a></li>
		<li><a href="#settings-3"><img
				src="img/icons/packs/fugue/24x24/credit-card.png" alt="" /><span>Invoicing</span></a></li>
	</ul>

	<div class="change_password">
		<form action="#" method="GET" class="validate" id="settings_password">
			<p>
				<label for="settings-password">New Password:</label> <input
					type="password" id="settings-password"
		...
		<div class="actions">
			<div class="right">
				<input form="settings_password" type="reset" value="Cancel"
					class="grey" /> <input form="settings_password" type="submit"
					value="OK" />
			</div>
		</div>
	</div>
			...
			<form action="#" method="GET">
				...
				<p>
					<label for="settings-pw">Password: </label> <input
						class="grey change_password_button" type="button" id="settings-pw"
						value="Change Password..." data-lang-changed="Password changed" />
				</p>
				</for>
		</div>
		<!-- End of #settings-1 -->
...
<div id="settings" class="settings-content" data-width=450>
	<div id="dialog_add_client" title="Add GL Account">
		...
		<form:form commandName="organizationBean" action="addClientGlAccount"
			method="POST" class="box validate" id="id_gl_account_form">
			<div class="row">
				<label for="d2_role"> <strong>GL Account Type</strong>
				</label>
				<div>
					<select name="accountType" id="id_accountType1" class="search"
						data-placeholder="Choose a accountType">
						<option value=-1>-----Select-----</option>
						<c:forEach items="${programData.glAccountType}" var="accTypeObj"
							varStatus="accTypeObjList">
							<option value="${accTypeObj}">${accTypeObj}</option>
						</c:forEach>
					</select>
				</div>
			</div>
			<div class="row">
				<label for="d2_username"> <strong>GL Account Name</strong>
				</label>
				<div>
					<input class="required" type="text" name="accountId"
						id="id_accountId1" />
				</div>
			</div>
			<div class="row">
				<label for="d2_email"> <strong>GL Account Number</strong>
				</label>
				<div>
					<input class="required" type="text" name="accountNumber"
						id="id_accountNumber1" />
				</div>
		...
		<div class="actions validate">
			<div class="left">
				<input type="button" value="Cancel" name=# id="id_popup_cancel"
					class="grey cancel" />
			</div>
			<div class="right">
				<input type="submit" value="Add GL Account" name=submit
					id="id_popup_glscreen" />
			</div>
		</div>
...
<!-- Message Dialog -->
<div style="display: none;" id="dialog_message"
	...
	<div class="actions">
		<div class="left">
			<input style="width: 320px;" type="text" name=d3_message
...
<section class="toolbar">
	<div class="user">
		<div class="avatar">
			<img src="img/layout/content/toolbar/user/avatar.png"> <span>200</span>
		</div>
	...
	<ul class="shortcuts">
		...
		<li><a href="javascript:void(0);"><span
				class="icon i24_user-business"></span></a> <!-- Possible sizes: small/medium/large -->
			<div class="small">
				<h3>Create a User</h3>
		...
		<li><a href="javascript:void(0);"><span
				class="icon i24_inbox-document"></span></a> <!-- Possible sizes: small/medium/large -->
			<div class="small">
				...
				<div class="content">
					<form class="full grid">
						<div class="row no-bg">
							...
							<p class="_100 small">
								<textarea rows=3 class="full-width" name="p2_message"
									id="p2_message" placeholder="Message"></textarea>
							</p>
						</div>
					</form>
				</div>
	...
	<input type="search" data-source="extras/search.php"
		...
		title="e.g. Peach" data-gravity=s>
</section>
<!-- End of .toolbar-->