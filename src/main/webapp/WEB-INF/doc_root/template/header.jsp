	...
	<div class="container_12">
		...
		<div class="right">
			<ul>
				...
				<li><a href="#"><span>3</span>Messages</a> <!-- Mail popup -->
					<div class="popup">
						<h3>New Messages</h3>
				...
				<li><a href="javascript:void(0);" id="btn-lock"><span>--:--</span>Lock
						screen</a></li>
...
<div class="container_12">
	...
	<!-- Your logos -->
	<a href="dashboard.html"><img src="img/logo-light.png" alt=""
		width="191" height="60"></a> <a class="phone-title"
		href="dashboard.html"><img src="img/logo-light.png" alt=""
		height="22" width="70" /></a>

	<div class="buttons">
		<a href=""> <span class="icon icon-sitemap"></span> Sitemap
		</a> <a href=""> <span class="icon icon-sitemap"></span> Help
		</a>
	</div>
	<!-- End of .buttons -->
</div>
<jsp:include page="/WEB-INF/doc_root/template/colorTab.jsp"></jsp:include>