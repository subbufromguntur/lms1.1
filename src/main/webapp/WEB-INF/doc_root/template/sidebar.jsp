...
<aside>
	<div class="top">
		...
		<nav>
			<ul class="collapsible accordion">
				...
				<li><a href="#"><img
						src="img/icons/packs/fugue/16x16/dashboard.png" alt="" height=16
						width=16>Dashboard</a></li>

				<li><a href="javascript:void(0);"><img
						src="img/icons/packs/fugue/16x16/ui-layered-pane.png" alt=""
						height=16 width=16>Manage Client</a>
					<ul>
						<li><a href="#" class="id_manageClient_addClientM">Add
								Client (M)</a></li>
						<li><a href="" id="test">Add Client (C)</a></li>
				...
				<li><a href="#"><img
						src="img/icons/packs/fugue/16x16/ui-layered-pane.png" alt=""
						height=16 width=16>Manage Roles</a>
					<ul>

						<li><a href="#" class="id_manageRoles_addRoleM">Add Role
								(M)</a></li>
				...
				<li><a href="javascript:void(0);"><img
						src="img/icons/packs/fugue/16x16/ui-layered-pane.png" alt=""
						height=16 width=16>Manage Users</a>
					<ul>
						<li><a href="#" class="id_manageUser_addUserM">Add User
								(M)</a></li>
				...
				<li><a href="javascript:void(0);"><img
						src="img/icons/packs/fugue/16x16/ui-layered-pane.png" alt=""
						height=16 width=16>Manage Program</a>
					<ul>
						<li><a href="#" class="id_manageProgram_addProgramM">Add
								Program (M)</a></li>
				...
				<li><a href="javascript:void(0);"><img
						src="img/icons/packs/fugue/16x16/ui-layered-pane.png" alt=""
						height=16 width=16>Manage Account</a>
					<ul>
				...
				<li><a href="javascript:void(0);"><img
						src="img/icons/packs/fugue/16x16/ui-layered-pane.png" alt=""
						height=16 width=16>Batch Process</a>
					<ul>
	...
	<div class="bottom sticky">
		...
		<div class="progress">
			<div class="bar" data-title="Space" data-value="1285" data-max="5120"
				data-format="0,0 MB"></div>
		</div>
	</div>
	<!-- End of .bottom -->
