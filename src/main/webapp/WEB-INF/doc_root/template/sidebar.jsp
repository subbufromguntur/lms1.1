    ...
    <!-- Navigation -->
                    <nav><ul class="collapsible accordion">
                        ...
                        <li><a href="#"><img src="img/icons/packs/fugue/16x16/dashboard.png" alt="" height=16 width=16>Dashboard</a></li>

                        <li>
                            <a href="javascript:void(0);"><img src="img/icons/packs/fugue/16x16/ui-layered-pane.png" alt="" height=16 width=16>Manage Client</a>
                            <ul>
                                <li><a href="#" class="id_manageClient_addClientM">Add Client (M)</a></li>
						...
						<li>
                            <a href="#"><img src="img/icons/packs/fugue/16x16/ui-layered-pane.png" alt="" height=16 width=16>Manage Roles</a>
                            <ul>
                             
                                <li><a  href="#" class="id_manageRoles_addRoleM">Add Role (M)</a></li>
						...
						<li>
                            ...
                            <ul>
                                <li><a href="#" class="id_manageUser_addUserM">Add User (M)</a></li>
