...
<title>LMS Admin Panel: Login</title>
...
<link rel="stylesheet"
	href="css/external/syntaxhighlighter/shThemeDefault.css" />
...
<body class=login>
	...
	<header class="container_12">
		...
		<div class="container">
			...
			<!-- Your logos -->
			<a href=""><img src="img/logo-light.png" alt="" width="210"
				height="67"></a> <a class="phone-title" href="login.html"><img
				src="logo-light.png" alt="" height="22" width="70" /></a>
	...
	<section id="login" class="container_12 clearfix">
		...
		<form:form commandName="lmsUserCredentails"
			action="userNamePasswordChanged" method="POST" class="box validate"
			id="id_login_form">
			<div class="header">
				<h2>
			...
			<div class="content">
				...
				<div class="form-box">
					...
					<div class="row">
						<label for="login_name"> <strong>Username</strong> <small>Or
								email address</small>
						</label>
						<div>
							<form:input id="id_username" class="required"
								placeholder="Enter Username" size="40" path="userName" />
							<form:errors path="userName" cssClass="errorClass" />
						</div>
					</div>

					<div class="row">
						<label for="login_pw"> <strong>Password</strong> <small><a
								href="javascript:void(0);" id="">Forgot it?</a></small>
						</label>
						<div>
							<form:input class="required" tabindex="2" type="password"
								path="password" id="id_password" size="42"
								placeholder="Enter Password" />
							<form:errors path="password" cssClass="errorClass" />
						</div>
					</div>
					<div class="row">
						<label for="login_pw"> <strong>New Password</strong>
						</label>
						<div>
							<form:input class="required" tabindex="2" type="password"
								path="changedPassword" id="id_changedpassword" size="42"
								placeholder="Enter Password" />
							<form:errors path="password" cssClass="errorClass" />
						</div>
					</div>
			...
			<div class="actions">
				<div class="left">
					<div class="rememberme">
						<input tabindex=4 type="checkbox" name="login_remember"
							id="login_remember" checked /><label for="login_remember">Remember
							me?</label>
					</div>
				</div>
				<div class="right">
		...
		<div id="id_errorDiv">${errorMessage}<br />
		</div>
	</section>
