...
<body class=login>
	...
	<header class="container_12">
		...
		<div class="container">
			...
			<!-- Your logos -->
			<a href=""><img src="img/logo-light.png" alt="" width="210" height="67"></a>
			<a class="phone-title" href="login.html"><img src="logo-light.png" alt="" height="22" width="70" /></a>
	...
	<section id="login" class="container_12 clearfix">
		...
		<form:form commandName="lmsUserCredentails" action="login" method="POST" class="box validate" id="id_login_form">
			<div class="header">
			...
			<div class="content">
				...
				<div class="form-box">
					...
					<div class="row">
						...
						<div>
							<form:input id="id_username" class="required" placeholder="Enter Username" size="40" path="userName"/>	
