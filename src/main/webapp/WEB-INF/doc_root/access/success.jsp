...
<body class=login>
	...
	<section id="index" class="container_12 clearfix">
	<form:form commandName="lmsUserCredentails" action="homePage"
			method="POST" class="box validate" id="id_login_form">
	<br><br><br>
	<div>
		<div id="id_errorDiv">${errorMessage}<br /></div>
		<div id="successMessage">${successMessage}<br /></div>
		<br>
		<div id="successMessage">
			<span class="icon icon-lock"></span>
			<input tabindex="3" type="submit" value="Logout" name="Logout"/>
			<input tabindex="3" type="submit" value="Continue"/>
		</div>
