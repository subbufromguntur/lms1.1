...
@Entity
@Table(name = "organizationnotification")
/**
 * A OrganizationNotification is someone who creates offers. This comment is also
 * included in the generated entity class.
 */
/*
 * This class is generated from the entity 'OrganizationNotification' defined in
 * the HEDL model.
 * 
...
public class OrganizationNotification {
	 ...
	 */
	@Deprecated
	public OrganizationNotification(long organizationId, long eventId, String description, int status) {
		super();
		if (description == null) {
	...
	/**
	 * Returns the value of property 'eventId'.
	 */
	...
	/**
	 * Sets the value of property 'eventId'.
	 */
	public void setEventId(long newValue) {
	...
	public boolean equals(Object obj) {
		...
		OrganizationNotification other = (OrganizationNotification) obj;
	...
	public String toString() {
		...
		result.append("OrganizationNotification-");
		result.append(getId());
		result.append(" [");
