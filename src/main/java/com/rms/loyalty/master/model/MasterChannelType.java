...
@Entity
@Table(name = "masterchanneltype")
/*
 * This class is generated from the entity 'MasterChannelType' defined in the HEDL
 * model.
 * 
 * Note: Any change made to this class will be overridden.
 */
public class MasterChannelType {
	 ...
	 */
	@Deprecated
	public MasterChannelType(String typeName, String description, int status) {
		super();
		if (typeName == null) {
	...
	public boolean equals(Object obj) {
		...
		MasterChannelType other = (MasterChannelType) obj;
	...
	public String toString() {
		...
		result.append("MasterChannelType-");
		result.append(getId());
		result.append(" [");
