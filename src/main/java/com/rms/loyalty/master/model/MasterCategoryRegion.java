...
@Entity
@Table(name = "mastercategoryregion")
/*
 * This class is generated from the entity 'MasterCategoryRegion' defined in the
 * HEDL model.
 * 
 * Note: Any change made to this class will be overridden.
 */
public class MasterCategoryRegion {
	 ...
	 */
	@Deprecated
	public MasterCategoryRegion(String regionName, String description, int status) {
		super();
		if (regionName == null) {
			throw new IllegalArgumentException("'regionName' must not be null.");
		}
		if (description == null) {
	...
	/**
	 * Returns the value of property 'regionName'.
	 */
	...
	/**
	 * Sets the value of property 'regionName'.
	 */
	public void setRegionName(String newValue) {
		if (newValue == null) {
			throw new IllegalArgumentException("'regionName' must not be null.");
		}
	...
	public boolean equals(Object obj) {
		...
		MasterCategoryRegion other = (MasterCategoryRegion) obj;
	...
	public String toString() {
		...
		result.append("MasterCategoryRegion-");
		result.append(getId());
		result.append(" [");
		result.append("regionName = ");
		result.append(getRegionName());
		result.append(", ");
