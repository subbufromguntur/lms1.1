...
public class HomeController {
	...
	public String getHomePage(Model model,@ModelAttribute("lmsUserCredentails") LmsUserCredentails loginBean, BindingResult errors, RedirectAttributes attributes) {
		return "home";
	}
