	...
	private Client convertClientBean(ClientBean clientBean) {
		...
		clientConfigurationDetails
				.setAddressLine2(clientConfigurationDetailsBean
						.getAddressLine2());
		clientConfigurationDetails.setCity(clientConfigurationDetailsBean
				.getCity() != null ? clientConfigurationDetailsBean.getCity()
				.split(",")[0] : "");
		clientConfigurationDetails.setCountry(clientConfigurationDetailsBean
				.getCountry() != null ? clientConfigurationDetailsBean
				.getCountry().split(",")[0] : "");
		clientConfigurationDetails.setPhone1(clientConfigurationDetailsBean
				.getPhone1());
		clientConfigurationDetails.setPhone2(clientConfigurationDetailsBean
				.getPhone2());
		clientConfigurationDetails.setState(clientConfigurationDetailsBean
		...
		for (ClientGlAccountBean clientGlAccountBean : clientGlAccountBeanList) {
			...
			clientGlAccount.setAccountNumber(clientGlAccountBean
					.getAccountNumber());
			clientGlAccount
			...
			clientGlAccount.setClientDto(client);
