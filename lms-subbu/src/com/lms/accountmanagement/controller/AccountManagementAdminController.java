...
import com.lms.accountmanagement.validator.LoginValidator;
...
public class AccountManagementAdminController {
	...
	public String submitClient(Model model, @ModelAttribute("clientBean") ClientBean clientBean) {
		model.addAttribute("message", "Client has been saved successfully.");
		
		this.accountManagementAdminService.submitClient(clientBean);
